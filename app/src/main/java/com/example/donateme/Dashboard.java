...
public class Dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dashboard_pg);
            ...
            public void onClick(View view) {
                ...
                usersRef.child(uid).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onCancelled(DatabaseError databaseError) {
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(Dashboard.this, "Error checking user existence", Toast.LENGTH_LONG).show();
                    }
                });
            }
        });
    ...
    private void showAlertDialogToRemoveCurrentPin(String id) {
        ...
        builder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(Dashboard.this, "Your pin is removed", Toast.LENGTH_LONG).show();
            }
        });
        //Create the AlertDialog
        AlertDialog alertDialog = builder.create();
